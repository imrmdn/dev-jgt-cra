 ...
 * @author Asani
 */
public class CallNotifWA extends DefaultApplicationPlugin {

    private String pluginName = "Telkom - CRA - Call Notif WA TSEL";
    ...
    public Object execute(Map map) {
        ...
        CallNotifWADao callNotifWaDao = new CallNotifWADao();
        List<String> phoneActs = getPhoneAct(cra_id);
...
//                                }
    ...
    public List<String> getPhoneAct(String cra_id) {
        DataSource ds = (DataSource) AppUtil.getApplicationContext().getBean("setupDataSource");
        Connection con = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        ...
        try {
            ...
            String query = "SELECT a.C_TEMP_CLOB_COLUMN, d.c_cra_id, "
                    ...
                    + "REGEXP_REPLACE(TO_CHAR(TO_DATE(a.c_berakhir, 'DD-MM-YYYY'), 'DD Month YYYY', 'NLS_DATE_LANGUAGE = Indonesian'), '\\s+', ' ') as awal, TO_CHAR(TO_DATE(c_waktu_selesai, 'HH:MI AM'), 'HH24:MI') as waktu_start "
...
//            String response = Utils.readResponse(connection);
//
