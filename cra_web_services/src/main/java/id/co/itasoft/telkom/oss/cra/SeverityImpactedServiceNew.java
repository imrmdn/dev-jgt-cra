...
import id.co.itasoft.telkom.oss.cra.dao.SeverityImpactedServiceDaoNew;
 ...
 * @author Asani
 */
public class SeverityImpactedServiceNew extends Element implements PluginWebSupport {

    String pluginName = "CRA - TEL - CRA Get Severity Service";
                ...
                try {
                    ...
                    if ((requestData.has("deviceId")
                        ...
                        try {
                            ...
                            SeverityImpactedServiceDaoNew severityImpactedServiceDao = new SeverityImpactedServiceDaoNew();
                            String hasilManggilApi = severityImpactedServiceDao.useBearerToken(severityImpactedServiceDao.getClientCredentials(), deviceId);
