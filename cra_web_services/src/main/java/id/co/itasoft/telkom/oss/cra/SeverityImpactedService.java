 ...
 * @author Asani
 */
public class SeverityImpactedService extends Element implements PluginWebSupport {
                ...
                try {
                    ...
                    if ((requestData.has("deviceId")
                        ...
                        try {
                            ...
                            SeverityImpactedServiceDao severityImpactedServiceDao = new SeverityImpactedServiceDao();
