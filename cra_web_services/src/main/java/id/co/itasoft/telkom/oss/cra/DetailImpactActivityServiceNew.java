...
import id.co.itasoft.telkom.oss.cra.dao.DetailImpactActivityDaoNew;
 ...
 * @author Asani
 */
public class DetailImpactActivityServiceNew extends Element implements PluginWebSupport {
                ...
                try {
                    ...
                    if ((requestData.has("deviceId")
                        ...
                        try {
                            ...
                            DetailImpactActivityDaoNew detailImpactActivityDao = new DetailImpactActivityDaoNew();
                            String hasilManggilApi = detailImpactActivityDao.useBearerToken(deviceId);
